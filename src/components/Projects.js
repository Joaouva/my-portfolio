				...
				<div className="projects-content-div">
					<div className="project-item">
						...
						<div className="container-project">
							<div className="img-container-project">
								<img src="../../images/bookish.png" alt="" />
							</div>
							...
							<div className="user-info">
								<h2>Bookish</h2>
								<span>
									Our loved app with a curated selection of
									books
								</span>
							</div>
						</div>
					...
					<div className="container-project">
						...
						<div className="user-info">
							<h2>Finna App</h2>
							<span>
								App to unleash the music stuck in your head
							</span>
							</div>
							</div>
					</div>
					<div className="project-item">
						...
						<div className="container-project">
							<div className="img-container-project">
								<img src="../../images/spacehack.png" alt="" />
							</div>
							<ul className="social-media">
								<li>
							...
							<div className="user-info">
								<h2>Spacehack</h2>
								<span>
									My first creation, it has a special place in
									my heart ❤️
								</span>
							</div>
						</div>
